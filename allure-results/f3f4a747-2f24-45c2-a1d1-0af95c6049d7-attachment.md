...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://www.saucedemo.com/inventory.html
Call log:
...
> 4  |   await page.goto('https://www.saucedemo.com/inventory.html', { timeout: 60000 });
  ...
  8  |     await expect(page.locator("//*[@class='inventory_item_name '][text()='Sauce Labs Backpack']")).toBeVisible()
  9  | })
  10 | 
